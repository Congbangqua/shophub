...
STRIPE_SUCCESS_URL = os.getenv("https://shophub-qs3z.vercel.app/payment/stripe/success")
STRIPE_CANCEL_URL = os.getenv("https://shophub-qs3z.vercel.app/payment/stripe/cancel")
...
PAYPAL_RETURN_URL = os.getenv("https://shophub-qs3z.vercel.app/payment/paypal/success")
PAYPAL_CANCEL_URL = os.getenv("https://shophub-qs3z.vercel.app/payment/stripe/cancel")
...
VNPAY_RETURN_URL = os.getenv("https://shophub-qs3z.vercel.app/payment/vnpay/success")
